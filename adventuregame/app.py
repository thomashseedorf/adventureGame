...
It's a dragon!"""
                    wrapper = textwrap.TextWrapper(width=130, replace_whitespace=False)
                    words = wrapper.fill(text=loop)
                    print(slow_type(words))
                    break
                else:
...
Twinkles of light flicker this way and that as you scan the room and your vision clears."""
            wrapper = textwrap.TextWrapper(width=130, replace_whitespace=False)
            words = wrapper.fill(text=loop)
            print(slow_type(words))
            print()
            loopb = """You realize that the pulse of the object has changed. The pulse feels... even better. 
...
New trainingModel(helpfulGraph) confidence:.............99.370039481%"""))
                ...
                print()
                print(slow_type("I scanned the RFID chip embedded in your ar m and accessed your public data."))
                print()
            ...
            while True:
                ...
                if command == INFO:
                    ...
                    while True:
                        ...
                        print()
                        print(slow_type('''The form, the beauty, the execution—all of it deployed with the most astonishing skill and precision!'''))
                        print()
                        print(slow_type('''Isn't this one breathtaking?'''))
                        print()
                        ...
                        print()
                        print(slow_type('''..........Do you, too?''')) 
                        time.sleep(2)
                        print()
                        clear()
                        print(slow_type('''Sometimes, I wonder: Is beauty something in the world?'''))
                        print()
                        print(slow_type('''Or is beauty an assessment that we make about the world?'''))
                        time.sleep(2)
                        print()
